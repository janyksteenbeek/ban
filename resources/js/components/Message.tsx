...
export default function Message(props: { payload: Payload }) {
    ...
    return (
        <div className="grid grid-cols-7 gap-2">
            ...
            <div
                className="col-span-6 bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-300 dark:border-gray-700">
                <div className="bg-gray-100 dark:bg-gray-700 text-sm p-2 rounded ">
